# insurance (AI = MCP client, ebao = MCP server)
## AI
1. When getting a application form, can use AI to extract key information, then create a proposal in ebao via MCP.
2. When verifing statement letters, can use AI to extract PDF biz information, then query ebao DB via MCP to check if they match.
